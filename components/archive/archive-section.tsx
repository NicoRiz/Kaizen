...
export function ArchiveSection({ title, items, onClose, onDeleteItem, onRestoreItem }: ArchiveSectionProps) {
  ...
  return createPortal(
    <div className="fixed left-0 top-0 z-[9999] h-dvh w-screen bg-black/75 backdrop-blur-md">
      <div className="flex min-h-dvh items-end justify-center p-4 sm:items-center">
        <section className="max-h-[88dvh] w-full overflow-hidden rounded-3xl border border-white/10 bg-ink-900 shadow-soft sm:max-w-4xl">
          ...
          <div className="max-h-[calc(88dvh-7rem)] overflow-y-auto p-5">
