...
const signals = [
  { label: "Daily tasks", icon: CheckCircle2 },
  { label: "Learning paths", icon: BookOpen },
  { label: "Content ideas", icon: Lightbulb },
  { label: "Thought archive", icon: Layers3 },
];
      ...
      <section className="mx-auto grid min-h-[calc(100vh-5rem)] max-w-6xl items-center gap-10 py-14 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="max-w-2xl">
          ...
          <p className="mt-6 max-w-xl text-lg leading-8 text-zinc-300">
            A calm dashboard for daily execution, useful content, learning resources,
            ideas, books, and personal reflection.
          </p>
          ...
          <div className="rounded-[1.5rem] border border-white/10 bg-ink-900 p-5">
            <div className="mb-6 flex items-center justify-between">
              <div>
                ...
                <h2 className="text-xl font-semibold text-zinc-50">Build momentum</h2>
              </div>
